...
@JsonIgnoreProperties({"_links"})
 public class Resource<T> extends ResourceSupport {
	...
	/**
	 * Creates a new {@link Resource} with the given content and {@link org.springframework.hateoas.Link}s (optional).
	 *
	...
	/**
	 * Creates a new {@link Resource} with the given content and {@link org.springframework.hateoas.Link}s.
	 *
	 * @param content must not be {@literal null}.
	 * @param links the links to add to the {@link Resource}.
	 */
